...
var _user$project$Main$view = function ($int) {
	return A2(
...
var _user$project$Main$whatever = _elm_lang$core$Native_Platform.incomingPort('whatever', _elm_lang$core$Json_Decode$int);
var _user$project$Main$NewInt = function (a) {
	return {ctor: 'NewInt', _0: a};
};
var _user$project$Main$subscriptions = function (model) {
	return _user$project$Main$whatever(_user$project$Main$NewInt);
};
